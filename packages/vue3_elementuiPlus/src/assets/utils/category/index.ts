...
const containerDomH = window.innerHeight - 120;
const containerDomW = window.innerWidth - 240;
...
export const data = {
  ...
  edges: [
    ...
    { source: "node10", target: "node11", label: "2-10" },
    { source: "node11", target: "node12", label: "2-12" },
  ],
};
// export const data = {
//   nodes: [
...
export const init = (containerDom: any, data: any) => {
  const width = containerDomW;
  const height = containerDomH;
